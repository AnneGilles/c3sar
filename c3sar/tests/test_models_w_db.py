...
class LicenseModelTests(unittest.TestCase):
    if DEBUG:  # pragma: no cover
        print "----- this is class LicenseModelTests "
...
class TrackModelTests(unittest.TestCase):
    if DEBUG:  # pragma: no cover
        print "----- this is class TrackModelTests "
...
class UserModelTests(unittest.TestCase):
    if DEBUG:  # pragma: no cover
        print "----- this is class UserModelTests "
    ...
    def test_constructor(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_constructor "
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()
    ...
    def test_user_listing(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_user_listing"
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()
        ...
        #print "UserModelTests.test_user_listing: result.__len__(): "
        #      + str(result.__len__())
        self.assertEqual(result.__len__(), 1, "Should have gotten 1 as result")

    def test_get_by_username(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_get_by_username"
        instance = self._makeOne()
        self.session.add(instance)
        #from c3sar.models import User
    ...
    def test_check_password(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_check_password"
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()
        result = self._getTargetClass().check_password(
            u'SomeUsername', u'password')
    ...
    def test_check_password_False(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_check_password_False"
        result = self._getTargetClass().check_password(
            u'nonexistant', u'somepassword')
    ...
    def test_check_username_exists_False(self):
        ...
        """
        if DEBUG:  # pragma: no cover
            print "--- this is UserModelTests.test_check_username_exists_False"
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()  # to get the id from the db
    ...
    def test_check_user_or_None(self):
        if DEBUG:  # pragma: no cover
            print "----- this is UserModelTests.test_check_user_or_None"
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()  # to get the id from the db
        ...
        #print "UserModelTests.test_check_user_or_None: type(result):"
        #      + str(type(result))
        self.assertTrue(result, "result was not True")

    def test_check_user_or_None_None(self):
        if DEBUG:  # pragma: no cover
            print "-- this is UserModelTests.test_check_user_or_None_None"
        instance = self._makeOne()
        self.session.add(instance)
        self.session.flush()  # to get the id from the db
...
#                          "<PhoneNumber('06421-98300422')>",
#                          "Got unecpected value from constructor!")
#         #print "repr: " + instance.__repr__()

class BandModelTests(unittest.TestCase):
    if DEBUG:  # pragma: no cover
        print "----- this is class BandModelTests "
    ...
    def _makeOne(self,
                 ...
                 registrar_id=1):
        return self._getTargetClass()(
            name, email, homepage, registrar, registrar_id)

    def test_constructor(self):
        if DEBUG:  # pragma: no cover
            print "----- this is BandModelTests.test_constructor "
        instance = self._makeOne()
        self.assertEqual(
            instance.name,
            'Some Band', "Got unecpected value from constructor!")
        self.assertEqual(
            instance.email,
            'someband@shri.de', "Got unecpected value from constructor!")
        self.assertEqual(
            instance.homepage,
            'http://someband.net', "Got unecpected value from constructor!")
        self.assertEqual(
            instance.registrar,
            'Some Registrar', "Got unecpected value from constructor!")
        #self.assertEqual(instance.__repr__(),
        #                 "<Band('06421-98300422')>",
        #                 "Got unecpected value from constructor!")
        #print "repr: " + instance.__repr__()
    ...
    def test_get_by_band_name(self):
        if DEBUG:  # pragma: no cover
            print "----- this is BandModelTests.test_get_by_bandname"
        instance = self._makeOne()
        self.session.add(instance)
    ...
    def test_get_by_registrar_name(self):
        ...
        if DEBUG:  # pragma: no cover
            print "BandModelTests.test_get_by_registrar_name: "
            "fooBandList: " + str(fooBandList)
...
class TestPlaylistModel(unittest.TestCase):
    if DEBUG:  # pragma: no cover
        print "----- this is class PlaylistModelTests "
...
#        browse_thread/thread/e12a4dd55917c079
